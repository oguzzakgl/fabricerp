...
const Onboarding: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0f1e] via-[#0d1a14] to-[#0a0f1e] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-green-600/8 via-transparent to-transparent pointer-events-none" />

      <div className="max-w-md w-full space-y-8 bg-slate-900/60 backdrop-blur-xl p-8 rounded-2xl border border-emerald-900/30 shadow-2xl shadow-emerald-900/10 relative z-10">
        <div className="text-center">
          <div className="flex justify-center mb-4">
            <div className="w-16 h-16 bg-gradient-to-tr from-emerald-600 to-green-500 rounded-2xl flex items-center justify-center shadow-lg shadow-emerald-500/25">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3 py-2.5 bg-slate-950/40 border border-slate-800 rounded-lg text-sm text-slate-200 placeholder-slate-600 focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 outline-none transition-all"
          ...
          <div className="flex flex-col gap-3">
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg text-sm font-bold text-white bg-gradient-to-r from-emerald-600 to-green-500 hover:from-emerald-700 hover:to-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 active:scale-98 transition-all disabled:opacity-50 shadow-lg shadow-emerald-500/20"
            >
              {loading ? (
